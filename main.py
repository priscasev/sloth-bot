...
async def on_member_update(before, after):
    ...
    patreon_roles = {
       ...
       int(os.getenv('HIGHESTRANK_EXPLORER_ROLE_ID')): [f"**Hype! {after.mention} is now the highest rank, `Sloth Explorer`!  <:zslothvcool:695411944332460053> **", "**Hey! Thank you for helping our community! You will be contacted by an Admin soon!**"]
    }
